<?php
    $sql_category_list = "SELECT * FROM category ORDER BY category_id ASC LIMIT 4";
...
<section class="collage pd-top">
    <div class="container">
        ...
        <div class="collage__items d-grid">
            ...
            ?>
                <div class="collage__item d-flex flex-column h-100 <?php if ($i == 0) { echo "collage__item--large"; } elseif ($i == 3) { echo "collage__item--finally";} else { echo ""; } ?>">
