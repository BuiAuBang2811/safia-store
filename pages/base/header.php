...
<header class="header">
    <div class="header__topbar">
        <div class="container p-relative d-flex space-between align-center">
            ...
            ?>
                <a class="h5 login-btn p-absolute" href="index.php?logout=1"><img class="image_login" src="./assets/images/icon/log-out.png" alt="Đăng xuất"><span>ĐĂNG XUẤT</span></a>
            <?php
            } else {
            ?>
                <a class="h5 login-btn p-absolute" href="index.php?page=login"><img class="image_login" src="./assets/images/icon/log-out.png" alt="Đăng nhập"><span>ĐĂNG NHẬP</span></a>
            <?php
            }
            ?>
        </div>
            ...
            <div class="header__container d-grid middle-left">
                ...
                <div class="header__logo d-flex justify-center align-center">
                    <a href="index.php" class="d-inline-block">
                        <img class="d-block w-100 svg__icon" src="./assets/images/logo/safia.png" alt="Logo" />
                    </a>
                </div>
