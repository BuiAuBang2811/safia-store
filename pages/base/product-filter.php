                        ...
                        <div class="sidebar__item--content product-detail__variant--items d-flex">
                            <div class="price__range">
                                ...
                                <div class="range-input">
                                    <input type="range" class="range-min" min="0" max="2000000" value="0" step="10000">
                                    <input type="range" class="range-max" min="0" max="2000000" value="2000000" step="10000">
                                </div>
                                <div class="price-input d-flex space-between">
                                    ...
                                    <div class="field">
                                        <input type="number" id="price-to" class="input-max h4" value="2000000">
