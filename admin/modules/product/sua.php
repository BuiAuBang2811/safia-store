                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-content">
                            ...
                            <div class="input-item form-group">
                                <label for="product_scent" class="d-block">Mùi hương (sản phẩm có những mùi hương nào)</label>
                                <div class="scent-list">
                                    ...
                                    $selected_scent_ids = array();
                                    while ($arr_variant = mysqli_fetch_array($query_variant)) {
                                        $selected_scent_ids[] = $arr_variant['scent_id'];
                                    }
                                    ...
                                    while ($row_scent = mysqli_fetch_array($query_scent_list)) {
                                        $checked = in_array($row_scent['scent_id'], $selected_scent_ids) ? 'checked' : '';
                                    ?>
                                        <div class="scent-item">
                                            <input type="checkbox" name="product_scent[]" value="<?php echo $row_scent['scent_id'] ?>" <?php echo $checked; ?>>
                                            <span class="scent-title"><?php echo $row_scent['scent_name'] ?></span>
                                        </div>
                                    <?php
                                    }
                                    ?>
                                    <a class="btn-add-scent " href="?action=scent&query=scent_add">+ Thêm lựa chọn</a>
                                </div>
                            </div>
                            <div class="input-item form-group">
