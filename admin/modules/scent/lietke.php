...
<div class="row">
    <div class="col">
        <div class="header__list d-flex space-between align-center">
            <h3 class="card-title" style="margin: 0;">Danh sách mùi hương</h3>
...
<div class="dialog__control">
    <div class="control__box">
        <a href="#" class="button__control" onclick="return confirm('Bạn có thực sự muốn xóa mùi hương này không?')" id="btnDelete">Xóa</a>
    </div>
</div>
<script>
