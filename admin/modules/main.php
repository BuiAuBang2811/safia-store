<div class="main-panel">
    <div class="content-wrapper">
        ...
        elseif($action =='scent' && $query == 'scent_list') {
            include("./modules/scent/lietke.php");
        }
        elseif($action =='scent' && $query == 'scent_add') {
            include("./modules/scent/them.php");
        }
        elseif($action =='scent' && $query == 'scent_edit') {
            include("./modules/scent/sua.php");
        }
